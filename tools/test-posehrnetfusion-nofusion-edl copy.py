# ------------------------------------------------------------------------------
# EDL Testing Script
# Based on test-posehrnetfusion-nofusion-dropout.py
# Single forward pass uncertainty estimation using Evidential Deep Learning
# No more 32x MC Dropout — uncertainty from NIG parameters directly
# ------------------------------------------------------------------------------
...
def parse_args():
    parser = argparse.ArgumentParser(description='Test keypoints network with EDL uncertainty')
...
def main():
    ...
    # evaluate on validation set — SINGLE FORWARD PASS (no MC Dropout loops)
    validate_posehrnetfusion_nofusion_edl(
