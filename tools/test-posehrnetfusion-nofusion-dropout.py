...
def _repeat_gray_to_3ch(x):
    """Repeat single-channel grayscale tensor to 3 channels.
    Defined at module level (not inside main) so it can be pickled
    by Windows multiprocessing DataLoader workers.
    """
