...
class EventRGBAlignedDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        trans_hm_to_img_event =  torch.tensor(trans_hm_to_img_event, dtype=torch.float)
        trans_crop_to_img_event = torch.tensor(trans_crop_to_img_event, dtype=torch.float)
        ...
        trans_hm_to_img_rgb =  torch.tensor(trans_hm_to_img_rgb, dtype=torch.float)
        trans_crop_to_img_rgb = torch.tensor(trans_crop_to_img_rgb, dtype=torch.float)
